...
const CompanyID = 8
const SheetID = '1OmLbOy0OGCBH0qGsRCrU5nwf13X7Zn1xnDsuyRVjjZE'
const CompanyName = 'Gks'
...
export const InsertAllGksProducts = async(req: Request,res: Response) => {
...
export const DeleteAllGksProducts = async(req: Request, res: Response) => {
  DeleteAllProductsByCompany(CompanyID)
  res.end(`All ${CompanyName} products deleted`);
}

export const DeleteAllGksCert = async(req: Request, res: Response) => {
...
export const GetAllInvalidGksCertificates = async(req,res) => {
