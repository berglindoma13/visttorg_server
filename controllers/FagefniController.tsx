...
//crtl-f Fagefni -> replace with company name

const CompanyID = 10
const SheetID = '1oTeBeVNb9BdtXhz5mxaTb6NQkNE9bGNhWr04WHdmdJE'
const CompanyName = 'Fagefni'
...
export const InsertAllFagefniProducts = async(req: Request,res: Response) => {
...
export const DeleteAllFagefniProducts = async(req: Request, res: Response) => {
  DeleteAllProductsByCompany(CompanyID)
  res.end(`All ${CompanyName} products deleted`);
}

export const DeleteAllFagefniCert = async(req: Request, res: Response) => {
...
export const GetAllInvalidFagefniCertificates = async(req,res) => {
