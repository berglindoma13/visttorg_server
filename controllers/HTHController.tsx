...
//crtl-f HTH -> replace with company name

const CompanyID = 11
const SheetID = '1VY_-e6F3MJV-g7oEHKJxUXAVSIUofikWA88kWLE8yB0'
const CompanyName = 'HTH'
...
export const InsertAllHTHProducts = async(req: Request,res: Response) => {
...
export const DeleteAllHTHProducts = async(req: Request, res: Response) => {
  DeleteAllProductsByCompany(CompanyID)
  res.end(`All ${CompanyName} products deleted`);
}

export const DeleteAllHTHCert = async(req: Request, res: Response) => {
...
export const GetAllInvalidHTHCertificates = async(req,res) => {
