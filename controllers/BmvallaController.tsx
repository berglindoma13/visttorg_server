...
const CompanyID = 7
const SheetID = '16DFLv344nhS-znCRiI2svEes0q0xiM5XjxzsCbIglKg'
const CompanyName = 'BMValla'
...
export const InsertAllBMVallaProducts = async(req: Request,res: Response) => {
...
export const DeleteAllBMVallaProducts = async(req: Request, res: Response) => {
  DeleteAllProductsByCompany(CompanyID)
  res.end(`All ${CompanyName} products deleted`);
}

export const DeleteAllBMVallaCert = async(req: Request, res: Response) => {
...
export const GetAllInvalidBMVallaCertificates = async(req,res) => {
